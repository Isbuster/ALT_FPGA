...
int main()
{
    ...
    IOWR_32DIRECT(I2C_MASTER_BASE, TFR_CMD, SECONDS);
    delay(1000);
    ...
    while (1)
    {
        ...
        IOWR_32DIRECT(I2C_MASTER_BASE, TFR_CMD, ((RTC_ADR<<0)));
    delay(1000);
        printf("FIFO not empty: %x\n", IORD_32DIRECT(I2C_MASTER_BASE, TFR_CMD_FIFO));
    delay(1000);   
        IOWR_32DIRECT(I2C_MASTER_BASE, TFR_CMD, SECONDS|STOP);
    delay(1000);
    ...
    delay(1000);
        ...
        svar = IORD_32DIRECT(I2C_MASTER_BASE, RX_DATA_FIFO); // Read the data from RX_DATA_FIFO
    delay(1000);
    ...
    printf("\nAntall RX_DATA: %d\n", 0xF & svar);
        ...
        for (int i = 0; i < (0xF & svar); i++)
        {
            // Wait for FIFO to be empty
            printf("RX_DATA: %x\n", IORD_32DIRECT(I2C_MASTER_BASE, RX_DATA));
    delay(1000);
        }
    }
